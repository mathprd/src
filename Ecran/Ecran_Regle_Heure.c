...
void Regle_Heure(void)
{
	...
	lv_obj_align(Roller_H, LV_ALIGN_CENTER, 110, 0);
	...
	lv_obj_align(Label, LV_ALIGN_CENTER, 110, -70);
	...
	lv_obj_align(Roller_M, LV_ALIGN_CENTER, 170, 0);
	...
	lv_obj_align(Label, LV_ALIGN_CENTER, 170, -70);
